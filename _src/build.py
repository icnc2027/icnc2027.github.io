...
NAV = [
  ...
  ("Information", [("Venue", "venue"), ("Information for Presenters", "information-for-presenters"),
               ("Social Events", "social-events"), ("Hotels", "hotels"),
...
PAGES = {
  ...
  "important-dates": ("Important Dates", "Key dates for abstract submission and registration for ICNC 2027.", "Abstracts & Registration"),
  "abstract-submission": ("Abstract Submission", "How to submit an abstract to ICNC 2027.", "Abstracts & Registration"),
  "registration": ("Registration", "Registration fees and conditions for ICNC 2027.", "Abstracts & Registration"),
  ...
  "hotels": ("Hotels", "Accommodation at Banff Centre and in the town of Banff for ICNC 2027.", "Information"),
